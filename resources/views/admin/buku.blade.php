      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <form method="POST" action="{{ route('insert-book') }}" enctype="multipart/form-data">
                  @csrf
                  <div class="card-body">
                    <div class="form-group">
                      <label for="jdlBuku">Judul Buku</label>
                      <input type="text" class="form-control" id="jdlBuku" placeholder="Judul Buku" name="jdl_buku" required>
                    </div>
                    <div class="form-group">
                      <label for="namaPengarang">Nama Pengarang</label>
                      <input type="text" class="form-control" id="namaPengarang" placeholder="Nama Pengarang" name="pengarang" required>
                    </div>
                    <div class="form-group">
                      <label for="jnsBuku">Jenis Buku</code></label>
