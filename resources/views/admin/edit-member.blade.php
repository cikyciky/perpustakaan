            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" style="width: 100%;" name="kelas">
                    ...
                    <option {{ $data->kelas == 'X' ? 'selected' : NULL }}>X</option>
                    <option {{ $data->kelas == 'XI' ? 'selected' : NULL }}>XI</option>
                    <option {{ $data->kelas == 'XII' ? 'selected' : NULL }}>XII</option>
                  </select>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="email" class="col-form-label">E-mail</label>
                  <input type="email" name="email" value="{{ $data->email }}" class="form-control" placeholder="info@gmail.com" required />
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="custom-control custom-radio">
                  <input class="custom-control-input" type="radio" value="Perempuan" id="customRadio1"  name="jk" name="jk" {{ $data->jk == 'p' ? 'checked' : NULL }}>
                  <label for="customRadio1" class="custom-control-label">Perempuan</label>
                </div>
                <div class="custom-control custom-radio">
                  <input class="custom-control-input" type="radio" value="Laki-laki" id="customRadio2" name="jk" name="jk" {{ $data->jk == 'l' ? 'checked' : NULL }}>
                  <label for="customRadio2" class="custom-control-label">Laki-laki</label>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="tlp" class="col-form-label">Telepon</label>
                  <input type="number" name="tlp" value="{{ $data->tlp }}" class="form-control" placeholder="085xxxxxx" required />
                </div>
                <!-- /.form-group -->
                <div class="form-group">
