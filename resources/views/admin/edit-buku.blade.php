          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item menu-open">
                <a href="{{ route('form-buku') }}" class="nav-link active">
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item"><a href="{{ route('data-buku') }}">Buku</a></li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
              ...
              <div class="col-md-6">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $data->jdl_buku }}" id="jdlBuku" placeholder="Judul Buku" name="jdl_buku">
                  </div>
                  <div class="form-group">
                    <label for="namaPengarang">Nama Pengarang</label>
                    <input type="text" class="form-control" value="{{ $data->pengarang }}" id="namaPengarang" placeholder="Nama Pengarang" name="pengarang">
                  </div>
                  <div class="form-group">
                    <label for="jnsBuku">Jenis Buku</label>
                    <select class="custom-select form-control-border" id="jnsBuku" name="jb">
                      <option {{ $data->jb == 'novel' ? 'selected' : NULL }} value="novel">Novel</option>
                      <option {{ $data->jb == 'komik' ? 'selected' : NULL }} value="komik">Komik</option>
                      <option {{ $data->jb == 'biografi' ? 'selected' : NULL }} value="biografi">Biografi</option>
                    </select>
                  </div>
                  ...
                  <div class="input-group">
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" value="{{ $data->gambar }}" id="exampleInputFile" name="gambar">
